...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      ...
      description:
        blog.excerpt ||
        `${blog.title} - بلاگ تخصصی درباره توسط کلینیک خواب دکتر ایمانی تبریز`,
      keywords: [
        "بلاگ خواب",
        "تحقیق اختلالات خواب",
      ...
      openGraph: {
        title: blog.title,
        description: blog.excerpt || `بلاگ تخصصی درباره ${blog.title}`,
        url: `/blogs/${slug}`,
        type: "article",
    ...
    // If blog is not found, return default metadata
    return {
      title: "بلاگ یافت نشد | کلینیک خواب دکتر ایمانی",
      description: "بلاگ مورد نظر یافت نشد. لطفاً صفحه بلاگ ها را بررسی کنید.",
    };
  }
}
