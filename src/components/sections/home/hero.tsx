    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-end justify-center px-4 text-center sm:items-start sm:px-8 sm:text-right">
        <div className="flex max-w-2xl flex-col items-center space-y-4 sm:space-y-6">
          ...
          >
            <h1 className="text-center text-3xl leading-tight font-extrabold text-white drop-shadow-lg sm:text-4xl md:text-5xl lg:text-6xl">
          ...
          >
            ...
            >
              نخستین مرکز فوق‌تخصصی تشخیص و درمان اختلالات خواب در شمال‌غرب
              کشور، دارای مجوز رسمی از دانشگاه علوم پزشکی تبریز.
            </p>
          </AnimatedSection>
